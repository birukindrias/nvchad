...
alias pa='php artisan serve'
alias nd='npm run dev'
alias b=' brightnessctl set '
alias psl='php -S localhost:8080'
alias ds='python manage.py startapp analytics'
alias sp='source venv/bin/activate'
alias cb='code /home/l/.bashrc'
alias sr='sudo reboot'
alias prs='python manage.py runserver'
alias bb='brightnessctl set 100'
alias c='cd ..'
...
alias mp='python manage.py makemigrations'
alias mpp='python manage.py migrate'
alias nn='cat ./nv.sh '
alias b1='b 100'
alias b5='b 500'

export PATH=$PATH:/usr/local/go/bin
# export PATH="$PATH:/path/to/bat:/path/to/rg"
export PATH="$PATH:/home/l/Downloads/nvim-linux64/bin"
export PATH="/opt/nvim/bin:$PATH"
alias na='no code/allprojects'
alias no='function _no() { cd "$1" && nvim .; }; _no'
